    ...
    <>
      <section id="portfolio" className="relative z-10 h-full lg:max-h-screen">
        <div className="slider mb-[50px] mt-[0px] h-screen md:mb-[0px] md:mt-[-150px]">
          ...
          <div className="thumbnail lg:absolute bottom-[-1050px] h-[100%] lg:h-[-250px] flex flex-col items-center justify-start relative gap-x-[30px] gap-y-[30px] overflow-y-scroll pb-[80px]  md:flex-row md:items-baseline lg:flex-wrap lg:justify-start lg:pb-[0px] ">
