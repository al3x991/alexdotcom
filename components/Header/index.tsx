        ...
        <div className="container">
          <div className="relative mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              <Link
                href="/"
                className={`header-logo block w-full ${sticky ? "" : "py-8"} `}
              >
                <h1 className="flex gap-0 text-4xl font-bold text-white">
                  Alex <FaCircle className=" ml-2 mt-5 text-lg text-lime" />
                </h1>
              </Link>
            </div>
                      ...
                      <li key={menuItem.id} className="group relative">
                        {menuItem.path ? (
                          ...
                          <>
                            ...
                            <div
                              className={`submenu relative left-0 top-full rounded-md bg-white transition-[top] duration-300 hover:text-lime group-hover:opacity-100 dark:bg-dark lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[250px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
